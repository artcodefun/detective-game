...
func CharacterFromDomain(c domain.Character) Character {
	return Character{
		...
		PrototypeID:             c.Prototype.ID,
		Name:                    c.Prototype.Name,
		Age:                     c.Prototype.Age,
		Profession:              c.Prototype.Profession,
		ImagePath:               c.Prototype.ImagePath,
		Personality:             c.Prototype.Personality,
		AudioToneID:             c.Prototype.AudioToneID,
